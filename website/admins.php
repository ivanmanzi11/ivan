...
<div class="banner">
  <main>
    <div class="col1">
        ...
        <a href=""><div class="home"> <button name="users"><i class="fa-solid fa-user" style="color: #000000;"></i>Users</button></div></a>
    ...
    if($_SERVER['REQUEST_METHOD']=="POST")    
    {
           /* $email =mysqli_real_escape_string($conn,$_POST['username']);  
            ...
            $query = "SELECT * FROM usertable where  userRole='admin'";
