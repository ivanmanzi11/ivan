...
<body>
    ...
    <div class="banner">
        <div class="navbar">  
            ...
            <ul>
            <li><a href="Dashboard.php?names=<?php echo $row['username'];?>">Dashboard</a></li>
            <li><a href="bsses in provinces.php">Search a business</a></li>
            <li><a href="booking.php">Reserve a spot</a></li>
    ...
    <hr/>
        ...
        <div class="content">
        <h2><b>Role: <u>Customer.</u></b></h2>
        <br/><br/>
            <h1>Welcome <u><?php echo $row['username'];?></u>
            <br/> To our<br/>
